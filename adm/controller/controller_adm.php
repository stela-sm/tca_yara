...
if(isset($_REQUEST["produto_delete"])){ //deleçao
   ...
   if(isset($_REQUEST["menu_new"])){ //adicionar menu
    $dados["folder"]="v";
    $dados["nome"]=$_REQUEST["nome"];
    ...
    $resp=menuNew($dados);
        if ($resp ==1){ //tudo certo
?>
            <form action="../view/menus_list.php" name="form" id="myForm" method="POST">
            <input type="hidden" name="msg" value="BD50">  <!-- "BD54" => "Registro apagado com sucesso.",-->
            </form> <!--envia um formulario com a variavel "msg", que é o código da mensagem de erro (ver view/msg.php)--> 
            <script>
            document.getElementById('myForm').submit();//envio automático submit()
...
?>
                <form action="../view/menus_list.php" name="form" id="myForm" method="POST">
                <input type="hidden" name="msg" value="BD02">  <!-- "BD54" => "Registro apagado com sucesso.",-->
                </form> <!--envia um formulario com a variavel "msg", que é o código da mensagem de erro (ver view/msg.php)--> 
                <script>
                document.getElementById('myForm').submit();//envio automático submit()
                </script>
...
//NOVO SUBMENU ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    if(isset($_REQUEST["submenu_new"])){ //adicionar menu
...
//EDITAR MENU ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        if(isset($_REQUEST["menu_edit"])){ //se veio do editar menu
...
//EDITAR SUBMENU ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
       ...
       if(isset($_REQUEST["submenu_edit"])){ //se veio do editar submenu
        $dados["id"]= $_REQUEST["id"];
...
?>
            <form action="../view/menus_list.php" name="form" id="myForm" method="POST">
            <input type="hidden" name="msg" value="BD54">  <!-- "BD54" => "Registro apagado com sucesso.",-->
            </form> <!--envia um formulario com a variavel "msg", que é o código da mensagem de erro (ver view/msg.php)--> 
            <script>
            document.getElementById('myForm').submit();//envio automático submit()
            </script>
